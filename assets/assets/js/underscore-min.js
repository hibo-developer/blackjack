    ...
    if (!0 !== a) {
      ...
      switch (o) {
        ...
        case "[object Boolean]":
          ...
          return !1;
        case "[object Symbol]":
          if (SymbolProto.valueOf.call(e) === SymbolProto.valueOf.call(t))
            continue;
          return !1;
        case "[object ArrayBuffer]":
        case tagDataView:
          n.push({ a: toBufferView(e), b: toBufferView(t) });
          continue;
      }
      var s = "[object Array]" === o;
      if (!s && isTypedArray$1(e)) {
      ...
      if (!(l >= 0))
        if ((r.push(e), i.push(t), n.push(!0), s)) {
          if ((l = e.length) !== t.length) return !1;
          for (; l--; ) n.push({ a: e[l], b: t[l] });
        } else {
          var p,
            h = keys(e);
          if (((l = h.length), keys(t).length !== l)) return !1;
          for (; l--; ) {
            if (!has$1(t, (p = h[l]))) return !1;
            n.push({ a: e[p], b: t[p] });
          }
        }
    } else (r.pop(), i.pop());
...
function flatten$1(e, t, n) {
  t || 0 === t || (t = 1 / 0);
  for (var r = [], i = 0, a = 0, u = getLength(e) || 0, o = []; 1; )
    if (a >= u) {
      if (!o.length) break;
      var s = o.pop();
      ((a = s.i), (e = s.v), (u = getLength(e)));
    } else {
      var c = e[a++];
      o.length >= t
        ? (r[i++] = c)
        : isArrayLike(c) && (isArray(c) || isArguments$1(c))
          ? (o.push({ i: a, v: e }), (a = 0), (u = getLength((e = c))))
          : n || (r[i++] = c);
    }
  return r;
}
